<div class="container-fluid marketplace-listings">
    <div
        ...
        <div class="section-text">
            <h1 class="text-xl navbar-brand">MY TRANSACTIONS</h1>
            <h1 class="text-sm text-muted">View your transaction history</h1>
        </div>
    </div>

    <ul class="mb-3 nav nav-tabs" id="transactionTabs" role="tablist">
        <li class="nav-item" role="presentation">
            <button class="nav-link active" id="buyer-transaction-tab" data-bs-toggle="tab"
                data-bs-target="#buyer-transaction" type="button" role="tab" aria-controls="buyer-transaction"
                aria-selected="true">
                As a Buyer ({{ $transactionsbuyer->count() }})
            </button>
        </li>
        <li class="nav-item" role="presentation">
            <button class="nav-link" id="seller-transaction-tab" data-bs-toggle="tab"
                data-bs-target="#seller-transaction" type="button" role="tab" aria-controls="seller-transaction"
                aria-selected="false">
        ...
        <div class="tab-pane fade show active" id="buyer-transaction" role="tabpanel"
            ...
            @else
                <div class="row row-cols-1 g-4">
                    @foreach ($transactionsbuyer as $transaction)
                        <div class="col-lg-12">
                                ...
                                <div class="border-0 shadow-sm modal-content">
                                    ...
                                    <div class="pt-2 modal-body">
                                        <div class="mb-4 text-center">
                                            <h4 class="mb-1">{{ $transaction->product->author->name }}</h4>
                                        </div>
                                        ...
                                        <form action="{{ route('transactions.review.store', $transaction) }}"
                                            ...
                                            <input type="hidden" name="reviewee_id"
                                                value="{{ $transaction->product->author->id }}">
