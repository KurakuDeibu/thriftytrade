        ...
        <aside class="p-3 sidebar">
            <div class="mb-4 text-center">
                ...
                <div class="px-2 py-2 mb-2 text-center card bg-light">
                    ...
                    <div class="mb-2 card bg-light"><a href="{{ route('dashboard') }}"
            ...
            @else
                @auth
                    {{-- MANAGE LISTINGS --}}
                    <div class="mb-2 card bg-light"><a href="{{ route('manage-listing') }}"
                            class="btn btn-outline-primary {{ Route::currentRouteName() === 'manage-listing' ? 'active' : '' }}">Manage
                            Listings</a>
                    </div>

                    {{-- MANAGE-OFFERS --}}
                    <div class="mb-2 card bg-light"><a href="{{ route('seller-offers') }}"
