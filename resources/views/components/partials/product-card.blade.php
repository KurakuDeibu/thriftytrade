...
<div class="col-lg-9">
    <main>
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                ...
                <div class="col">
                    <a wire:navigate href="/marketplace/product/{{ $products->id }}">
                        <div class="card h-100 item-card">
                            <img src="{{ $products->prodImage }}" alt="Vintage Lamp" class="card-img-top item-image">
                            <div class="card-body">
            ...
            <a class="text-center text-lg mt-4 block" href="#"><div class="btn btn-outline-primary">More Featured</div></a>
