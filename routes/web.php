...
// Route::get('/users', [SendMessageController::class, 'userChats']);
// Route::get('/messages/user/{id}', [SendMessageController::class, 'showMessages']);
...
Route::middleware(['auth', 'verified'])->group( function () {
    ...
    Route::get('/user/offers', [ProductController::class, 'dashboard'])->name('seller-offers')->middleware('auth','verified');
    // ---------------UPDATE THE STATUS---------------//
